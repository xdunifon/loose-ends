...
public interface IRoundService
{
    ...
    Task<IEnumerable<RoundPromptDto>> GetPromptsByRoundIdAsync(int roundId);
    Task<RoundPromptDto> GetPromptByIdAsync(int roundPromptId);
    Task AnswerPromptAsync(AnswerPromptRequest req);

    Task<IEnumerable<VotingDto>?> GetVotingOptionsBySessionId(int sessionId, int playerId);
...
public class RoundService(GameContext context, IHubContext<GameHub> hub) : BaseService(context), IRoundService
{
    ...
    public async Task<IEnumerable<RoundPromptDto>> GetPromptsByRoundIdAsync(int roundId)
    {
    ...
    public async Task<IEnumerable<VotingDto>?> GetVotingOptionsBySessionId(int sessionId, int playerId)
    {
